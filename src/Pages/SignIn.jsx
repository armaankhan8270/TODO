...
const SignIn = () => {
    return (
<div className='bg-slate-900 mt-24 pb-20 '>
    h

        <div className='border-2 bg-white rounded-[20px] mt-12 border-1 h-[700px] w-[400px]  shadow-lg overflow-hidden  ml-[650px] p ' >
    <h1 className='text-center text-3xl mt-12'>Login</h1>
            <div className='text-center text-white mt-24 '>
            <label className='text-black' htmlFor="Name">
<input placeholder='userName' type="text"className=' border-b-2 pb-2  font-extrabold text-xl  uppercase outline-none  focus:outline-none overflow-hidden overflow-hidden' /></label>
<input placeholder='Password' type="password"className='mt-12 text-black border-b-2 bg-white pb-2 selg-center text-xl font-extrabold uppercase outline-none focus:outline-none mr-0' />
<button className='p-2 h-12 self-center text-xl bg-purple-900 mt-4 text-white w-[400px] rounded-lg'>Login</button>
<h1 className='text-black mt-12 text-2xl'>or SignUp Using</h1>
<div className='mt-12'>
